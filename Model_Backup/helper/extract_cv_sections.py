...
def extract_section(text, section_names, all_section_names):
    ...
    # Split text into words (with separators to preserve spaces/newlines)
    ...
    # Cleanup: normalize multiple spaces/newlines
...
ALL_SECTION_NAMES = [
    ...
    'education', 'academic background', 'educational qualifications', 'qualifications', 'academic qualifications', 'extracurriculars'
]
